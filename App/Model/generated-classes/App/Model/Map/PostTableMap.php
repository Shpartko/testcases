...
class PostTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.PostTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Model\\Post';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Model.Post';
     ...
     */
    const COL_USERNAME = 'post.username';

    /**
     * the column name for the topic_id field
     */
    const COL_TOPIC_ID = 'post.topic_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Text', 'Username', 'TopicId', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'text', 'username', 'topicId', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(PostTableMap::COL_ID, PostTableMap::COL_TEXT, PostTableMap::COL_USERNAME, PostTableMap::COL_TOPIC_ID, PostTableMap::COL_CREATED_AT, PostTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'text', 'username', 'topic_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Text' => 1, 'Username' => 2, 'TopicId' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'text' => 1, 'username' => 2, 'topicId' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(PostTableMap::COL_ID => 0, PostTableMap::COL_TEXT => 1, PostTableMap::COL_USERNAME => 2, PostTableMap::COL_TOPIC_ID => 3, PostTableMap::COL_CREATED_AT => 4, PostTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'text' => 1, 'username' => 2, 'topic_id' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Model\\Post');
    ...
    {
        $this->addRelation('Topic', '\\App\\Model\\Topic', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':topic_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PostTableMap::COL_USERNAME);
            $criteria->addSelectColumn(PostTableMap::COL_TOPIC_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Post) { // it's a model object
