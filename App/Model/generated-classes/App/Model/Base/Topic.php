...
abstract class Topic implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\TopicTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Topic object.
     */
     ...
     * @return $this|\App\Model\Topic The current object (for fluent API support)
     */
    ...
    public function setBody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[TopicTableMap::COL_BODY] = true;
        }
    ...
    public function setUsername($v)
    {
        ...
        if ($this->username !== $v) {
            $this->username = $v;
            $this->modifiedColumns[TopicTableMap::COL_USERNAME] = true;
        }
    ...
    public function setViews($v)
    {
        ...
        if ($this->views !== $v) {
            $this->views = $v;
            $this->modifiedColumns[TopicTableMap::COL_VIEWS] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TopicTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TopicTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TopicTableMap::translateFieldName('Body', TableMap::TYPE_PHPNAME, $indexType)];
            $this->body = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TopicTableMap::translateFieldName('Username', TableMap::TYPE_PHPNAME, $indexType)];
            $this->username = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TopicTableMap::translateFieldName('Views', TableMap::TYPE_PHPNAME, $indexType)];
            $this->views = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TopicTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TopicTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\Topic'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TopicTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
                if (!$this->isColumnModified(TopicTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(TopicTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TopicTableMap::COL_BODY)) {
            $modifiedColumns[':p' . $index++]  = 'body';
        }
        if ($this->isColumnModified(TopicTableMap::COL_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = 'username';
        }
        if ($this->isColumnModified(TopicTableMap::COL_VIEWS)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Topic The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TopicTableMap::COL_BODY)) {
            $criteria->add(TopicTableMap::COL_BODY, $this->body);
        }
        if ($this->isColumnModified(TopicTableMap::COL_USERNAME)) {
            $criteria->add(TopicTableMap::COL_USERNAME, $this->username);
        }
        if ($this->isColumnModified(TopicTableMap::COL_VIEWS)) {
            $criteria->add(TopicTableMap::COL_VIEWS, $this->views);
        }
        if ($this->isColumnModified(TopicTableMap::COL_CREATED_AT)) {
            $criteria->add(TopicTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(TopicTableMap::COL_UPDATED_AT)) {
            $criteria->add(TopicTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Topic (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Topic Clone of current object.
     * @throws PropelException
     */
    ...
    public function initPosts($overrideExisting = true)
    {
        ...
        $this->collPosts->setModel('\App\Model\Post');
    }
